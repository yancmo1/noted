...
- Team: `9PHS626XUN`
- Build: Debug, Xcode 27 beta, Noted app bundle `com.memorygarden.ios` (bundle identifier retained for upgrade compatibility)
...
| Launch | Pass | `devicectl device process launch --device yPhone com.memorygarden.ios` reported Noted launched |
