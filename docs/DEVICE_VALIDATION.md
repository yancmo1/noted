...
- Team: `9PHS626XUN`
- Build: Debug, Xcode 27 beta, bundle `com.memorygarden.ios`
...
| Launch | Pass | `devicectl device process launch --device yPhone com.memorygarden.ios` reported application launched |
