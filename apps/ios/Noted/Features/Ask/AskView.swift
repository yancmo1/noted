        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    VStack(alignment: .leading, spacing: 6) { Text("ASK YOUR MEMORY").font(.caption.bold()).tracking(1.2).foregroundStyle(Color.notedPrimary); Text("What do you remember?").font(.largeTitle.bold()); Text("Answers stay grounded in what you have captured.").foregroundStyle(.secondary) }
